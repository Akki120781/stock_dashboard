      ...
      <FlowSection aria-label="Qui nous sommes" style={{ backgroundColor: '#fd5200', color: '#fff' }}>
        <div className="flex justify-between items-center w-full">
          ...
          <Button 
            variant="outline" 
            onClick={() => router.push('/')}
            className="border-white/20 text-white hover:bg-white/10 hover:text-white text-xs px-3 py-1 h-auto"
          >
            Back to Home
          </Button>
        </div>
        ...
        <div>
          <h1
            className="text-[clamp(3.5rem,10vw,12rem)] font-bold leading-[0.85] uppercase tracking-tight"
          >
            Create
            <br />
            Without
